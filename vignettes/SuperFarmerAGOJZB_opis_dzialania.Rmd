...
SuperFarmerAGOJZB::badaj_gre(strategia1=SuperFarmerAGOJZB::strategia_AGOJZB, co_chcesz = "statystyki", ilosc_wywolan=100)
```
```{r, warning=FALSE,fig.width=6, fig.height=2.5}
SuperFarmerAGOJZB::badaj_gre(strategia1=SuperFarmerAGOJZB::strategia_AGOJZB, co_chcesz ="histogram", ilosc_wywolan=100)
```
```{r, warning=FALSE,fig.width=6, fig.height=2.5}
SuperFarmerAGOJZB::badaj_gre(strategia1=SuperFarmerAGOJZB::strategia_AGOJZB, co_chcesz ="wykres_gestosci", ilosc_wywolan=100)
```
```{r, warning=FALSE,fig.width=4, fig.height=2.5}
SuperFarmerAGOJZB::badaj_gre(strategia1=SuperFarmerAGOJZB::strategia_AGOJZB, co_chcesz ="wykres_skrzypcowy", ilosc_wywolan=100)
```
...
SuperFarmerAGOJZB::badaj_gre(strategia2=SuperFarmerAGOJZB::strategia_AGOJZB_kroliki,co_chcesz = "statystyki", ilosc_wywolan=100)
```
```{r, warning=FALSE,fig.width=6, fig.height=5}
SuperFarmerAGOJZB::badaj_gre(strategia2=SuperFarmerAGOJZB::strategia_AGOJZB_kroliki, co_chcesz ="histogram", ilosc_wywolan=100)
```
```{r, warning=FALSE,fig.width=6, fig.height=5}
SuperFarmerAGOJZB::badaj_gre(strategia2=SuperFarmerAGOJZB::strategia_AGOJZB_kroliki, co_chcesz ="wykres_gestosci", ilosc_wywolan=100)
```
```{r, warning=FALSE,fig.width=6, fig.height=5}
SuperFarmerAGOJZB::badaj_gre(strategia2=SuperFarmerAGOJZB::strategia_AGOJZB_kroliki, co_chcesz ="wykres_skrzypcowy", ilosc_wywolan=100)
```
